...
cljs.reader.StringPushbackReader.prototype.cljs$reader$PushbackReader$unread$arity$2 = function(reader, ch) {
  var self__ = this;
  return cljs.core.swap_BANG_.call(null, self__.buffer_atom, function(p1__2921_SHARP_) {
    return cljs.core.cons.call(null, ch, p1__2921_SHARP_)
  })
};
...
cljs.reader.reader_error = function() {
  ...
  reader_error.cljs$lang$applyTo = function(arglist__2922) {
    var rdr = cljs.core.first(arglist__2922);
    var msg = cljs.core.rest(arglist__2922);
...
cljs.reader.read_token = function read_token(rdr, initch) {
  ...
  while(true) {
    if(function() {
      ...
      var G__2923 = function() {
        sb.append(ch);
        return sb
      }();
      var G__2924 = cljs.reader.read_char.call(null, rdr);
      sb = G__2923;
      ch = G__2924;
      continue
    }
...
cljs.reader.read_past = function read_past(pred, rdr) {
  ...
  while(true) {
    if(cljs.core.truth_(pred.call(null, ch))) {
      var G__2925 = cljs.reader.read_char.call(null, rdr);
      ch = G__2925;
      continue
    }else {
      return ch
  ...
  while(true) {
    ...
    if(delim === ch) {
      ...
      if(cljs.core.truth_(temp__3971__auto__)) {
        ...
        var G__2926 = mret === rdr ? a : cljs.core.conj_BANG_.call(null, a, mret);
        a = G__2926;
        continue
      }else {
        cljs.reader.unread.call(null, rdr, ch);
        var o = cljs.reader.read.call(null, rdr, true, null, recursive_QMARK_);
        var G__2927 = o === rdr ? a : cljs.core.conj_BANG_.call(null, a, o);
        a = G__2927;
        continue
      }
    }
...
cljs.reader.read_number = function read_number(reader, initch) {
  ...
  while(true) {
    if(cljs.core.truth_(function() {
      ...
      var G__2928 = function() {
        buffer.append(ch);
        return buffer
      }();
      var G__2929 = cljs.reader.read_char.call(null, reader);
      buffer = G__2928;
      ch = G__2929;
      continue
    }
...
cljs.reader.read_string_STAR_ = function read_string_STAR_(reader, _) {
  ...
  while(true) {
    if(ch == null) {
      ...
      if("\\" === ch) {
        var G__2930 = function() {
          buffer.append(cljs.reader.escape_char.call(null, buffer, reader));
          return buffer
        }();
        var G__2931 = cljs.reader.read_char.call(null, reader);
        buffer = G__2930;
        ch = G__2931;
        continue
      }else {
        if('"' === ch) {
          ...
          if("\ufdd0'default") {
            var G__2932 = function() {
              buffer.append(ch);
              return buffer
            }();
            var G__2933 = cljs.reader.read_char.call(null, reader);
            buffer = G__2932;
            ch = G__2933;
            continue
          }else {
...
cljs.reader.read_meta = function read_meta(rdr, _) {
  ...
  if(function() {
    ...
    if(G__2935) {
      if(function() {
        var or__3824__auto__ = G__2935.cljs$lang$protocol_mask$partition0$ & 262144;
        if(or__3824__auto__) {
          return or__3824__auto__
        }else {
          return G__2935.cljs$core$IWithMeta$
        }
      }()) {
        return true
      }else {
        if(!G__2935.cljs$lang$protocol_mask$partition0$) {
          return cljs.core.type_satisfies_.call(null, cljs.core.IWithMeta, G__2935)
        }else {
          return false
        }
      }
  ...
  while(true) {
    ...
    if(ch == null) {
      ...
      if(cljs.reader.whitespace_QMARK_.call(null, ch)) {
        var G__2936 = reader;
        var G__2937 = eof_is_error;
        var G__2938 = sentinel;
        var G__2939 = is_recursive;
        reader = G__2936;
        eof_is_error = G__2937;
        sentinel = G__2938;
        is_recursive = G__2939;
        continue
      }else {
        if(cljs.reader.comment_prefix_QMARK_.call(null, ch)) {
          var G__2940 = cljs.reader.read_comment.call(null, reader, ch);
          var G__2941 = eof_is_error;
          var G__2942 = sentinel;
          var G__2943 = is_recursive;
          reader = G__2940;
          eof_is_error = G__2941;
          sentinel = G__2942;
          is_recursive = G__2943;
          continue
        }else {
          if("\ufdd0'else") {
            ...
            if(res === reader) {
              var G__2944 = reader;
              var G__2945 = eof_is_error;
              var G__2946 = sentinel;
              var G__2947 = is_recursive;
              reader = G__2944;
              eof_is_error = G__2945;
              sentinel = G__2946;
              is_recursive = G__2947;
              continue
            }else {
              return res
            }
...
cljs.reader.parse_and_validate_timestamp = function() {
  ...
  return function(ts) {
    ...
    if(cljs.core.truth_(temp__3974__auto__)) {
      var vec__2953 = temp__3974__auto__;
      var vec__2954 = cljs.core.nth.call(null, vec__2953, 0, null);
      var _ = cljs.core.nth.call(null, vec__2954, 0, null);
      var years = cljs.core.nth.call(null, vec__2954, 1, null);
      var months = cljs.core.nth.call(null, vec__2954, 2, null);
      var days = cljs.core.nth.call(null, vec__2954, 3, null);
      var hours = cljs.core.nth.call(null, vec__2954, 4, null);
      var minutes = cljs.core.nth.call(null, vec__2954, 5, null);
      var seconds = cljs.core.nth.call(null, vec__2954, 6, null);
      var milliseconds = cljs.core.nth.call(null, vec__2954, 7, null);
      var vec__2955 = cljs.core.nth.call(null, vec__2953, 1, null);
      var ___$1 = cljs.core.nth.call(null, vec__2955, 0, null);
      var ___$2 = cljs.core.nth.call(null, vec__2955, 1, null);
      var ___$3 = cljs.core.nth.call(null, vec__2955, 2, null);
      var V = vec__2953;
      var vec__2956 = cljs.core.map.call(null, function(v) {
        return cljs.core.map.call(null, function(p1__2952_SHARP_) {
          return parseInt(p1__2952_SHARP_, 10)
        }, v)
      }, cljs.core.map.call(null, function(p1__2950_SHARP_, p2__2949_SHARP_) {
        return cljs.core.update_in.call(null, p2__2949_SHARP_, cljs.core.PersistentVector.fromArray([0], true), p1__2950_SHARP_)
      }, cljs.core.PersistentVector.fromArray([cljs.core.constantly.call(null, null), function(p1__2951_SHARP_) {
        if(cljs.core._EQ_.call(null, p1__2951_SHARP_, "-")) {
          return"-1"
        }else {
          return"1"
        }
      }], true), V));
      var vec__2957 = cljs.core.nth.call(null, vec__2956, 0, null);
      var ___$4 = cljs.core.nth.call(null, vec__2957, 0, null);
      var y = cljs.core.nth.call(null, vec__2957, 1, null);
      var mo = cljs.core.nth.call(null, vec__2957, 2, null);
      var d = cljs.core.nth.call(null, vec__2957, 3, null);
      var h = cljs.core.nth.call(null, vec__2957, 4, null);
      var m = cljs.core.nth.call(null, vec__2957, 5, null);
      var s = cljs.core.nth.call(null, vec__2957, 6, null);
      var ms = cljs.core.nth.call(null, vec__2957, 7, null);
      var vec__2958 = cljs.core.nth.call(null, vec__2956, 1, null);
      var offset_sign = cljs.core.nth.call(null, vec__2958, 0, null);
      var offset_hours = cljs.core.nth.call(null, vec__2958, 1, null);
      var offset_minutes = cljs.core.nth.call(null, vec__2958, 2, null);
...
cljs.reader.parse_timestamp = function parse_timestamp(ts) {
  ...
  if(cljs.core.truth_(temp__3971__auto__)) {
    var vec__2960 = temp__3971__auto__;
    var years = cljs.core.nth.call(null, vec__2960, 0, null);
    var months = cljs.core.nth.call(null, vec__2960, 1, null);
    var days = cljs.core.nth.call(null, vec__2960, 2, null);
    var hours = cljs.core.nth.call(null, vec__2960, 3, null);
    var minutes = cljs.core.nth.call(null, vec__2960, 4, null);
    var seconds = cljs.core.nth.call(null, vec__2960, 5, null);
    var ms = cljs.core.nth.call(null, vec__2960, 6, null);
    var offset = cljs.core.nth.call(null, vec__2960, 7, null);
      ...
      while(true) {
        if(cljs.core._EQ_.call(null, limit__$1, 1)) {
          ...
          if(cljs.core.truth_(temp__3971__auto__)) {
            ...
            var G__2961 = s__$1.substring(index + cljs.core.count.call(null, m));
            var G__2962 = limit__$1 - 1;
            var G__2963 = cljs.core.conj.call(null, parts, s__$1.substring(0, index));
            s__$1 = G__2961;
            limit__$1 = G__2962;
            parts = G__2963;
            continue
...
clojure.string.escape = function escape(s, cmap) {
  ...
  while(true) {
    if(cljs.core._EQ_.call(null, length, index)) {
      ...
      var temp__3971__auto___2965 = cljs.core._lookup.call(null, cmap, ch, null);
      if(cljs.core.truth_(temp__3971__auto___2965)) {
        var replacement_2966 = temp__3971__auto___2965;
        buffer.append([cljs.core.str(replacement_2966)].join(""))
      }else {
        buffer.append(ch)
      }
      var G__2967 = index + 1;
...
jQuery.prototype.call = function() {
  var G__2861 = null;
  var G__2861__2 = function(self__, k) {
    var self____$1 = this;
    var this$ = self____$1;
    return cljs.core._lookup.call(null, this$, k)
  };
  var G__2861__3 = function(self__, k, not_found) {
    var self____$1 = this;
    var this$ = self____$1;
    return cljs.core._lookup.call(null, this$, k, not_found)
  };
  G__2861 = function(self__, k, not_found) {
    switch(arguments.length) {
      case 2:
        return G__2861__2.call(this, self__, k);
      case 3:
        return G__2861__3.call(this, self__, k, not_found)
    }
    throw new Error("Invalid arity: " + arguments.length);
  };
  return G__2861
}();
jQuery.prototype.apply = function(self__, args2860) {
  return self__.call.apply(self__, [self__].concat(args2860.slice()))
};
...
jayq.core.hide = function() {
  var hide__delegate = function($elem, p__2862) {
    var vec__2864 = p__2862;
    var speed = cljs.core.nth.call(null, vec__2864, 0, null);
    var on_finish = cljs.core.nth.call(null, vec__2864, 1, null);
    return $elem.hide(speed, on_finish)
  };
  var hide = function($elem, var_args) {
    var p__2862 = null;
    if(goog.isDef(var_args)) {
      p__2862 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0)
    }
    return hide__delegate.call(this, $elem, p__2862)
  };
  hide.cljs$lang$maxFixedArity = 1;
  hide.cljs$lang$applyTo = function(arglist__2865) {
    var $elem = cljs.core.first(arglist__2865);
    var p__2862 = cljs.core.rest(arglist__2865);
    return hide__delegate($elem, p__2862)
  };
  hide.cljs$lang$arity$variadic = hide__delegate;
  return hide
}();
jayq.core.show = function() {
  var show__delegate = function($elem, p__2866) {
    var vec__2868 = p__2866;
    var speed = cljs.core.nth.call(null, vec__2868, 0, null);
    var on_finish = cljs.core.nth.call(null, vec__2868, 1, null);
    return $elem.show(speed, on_finish)
  };
  var show = function($elem, var_args) {
    var p__2866 = null;
    if(goog.isDef(var_args)) {
      p__2866 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0)
    }
    return show__delegate.call(this, $elem, p__2866)
  };
  show.cljs$lang$maxFixedArity = 1;
  show.cljs$lang$applyTo = function(arglist__2869) {
    var $elem = cljs.core.first(arglist__2869);
    var p__2866 = cljs.core.rest(arglist__2869);
    return show__delegate($elem, p__2866)
  };
  show.cljs$lang$arity$variadic = show__delegate;
  return show
}();
jayq.core.toggle = function() {
  var toggle__delegate = function($elem, p__2870) {
    var vec__2872 = p__2870;
    var speed = cljs.core.nth.call(null, vec__2872, 0, null);
    var on_finish = cljs.core.nth.call(null, vec__2872, 1, null);
    return $elem.toggle(speed, on_finish)
  };
  var toggle = function($elem, var_args) {
    var p__2870 = null;
    if(goog.isDef(var_args)) {
      p__2870 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0)
    }
    return toggle__delegate.call(this, $elem, p__2870)
  };
  toggle.cljs$lang$maxFixedArity = 1;
  toggle.cljs$lang$applyTo = function(arglist__2873) {
    var $elem = cljs.core.first(arglist__2873);
    var p__2870 = cljs.core.rest(arglist__2873);
    return toggle__delegate($elem, p__2870)
  };
  toggle.cljs$lang$arity$variadic = toggle__delegate;
  return toggle
}();
jayq.core.fade_out = function() {
  var fade_out__delegate = function($elem, p__2874) {
    var vec__2876 = p__2874;
    var speed = cljs.core.nth.call(null, vec__2876, 0, null);
    var on_finish = cljs.core.nth.call(null, vec__2876, 1, null);
    return $elem.fadeOut(speed, on_finish)
  };
  var fade_out = function($elem, var_args) {
    var p__2874 = null;
    if(goog.isDef(var_args)) {
      p__2874 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0)
    }
    return fade_out__delegate.call(this, $elem, p__2874)
  };
  fade_out.cljs$lang$maxFixedArity = 1;
  fade_out.cljs$lang$applyTo = function(arglist__2877) {
    var $elem = cljs.core.first(arglist__2877);
    var p__2874 = cljs.core.rest(arglist__2877);
    return fade_out__delegate($elem, p__2874)
  };
  fade_out.cljs$lang$arity$variadic = fade_out__delegate;
  return fade_out
}();
jayq.core.fade_in = function() {
  var fade_in__delegate = function($elem, p__2878) {
    var vec__2880 = p__2878;
    var speed = cljs.core.nth.call(null, vec__2880, 0, null);
    var on_finish = cljs.core.nth.call(null, vec__2880, 1, null);
    return $elem.fadeIn(speed, on_finish)
  };
  var fade_in = function($elem, var_args) {
    var p__2878 = null;
    if(goog.isDef(var_args)) {
      p__2878 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0)
    }
    return fade_in__delegate.call(this, $elem, p__2878)
  };
  fade_in.cljs$lang$maxFixedArity = 1;
  fade_in.cljs$lang$applyTo = function(arglist__2881) {
    var $elem = cljs.core.first(arglist__2881);
    var p__2878 = cljs.core.rest(arglist__2881);
    return fade_in__delegate($elem, p__2878)
  };
  fade_in.cljs$lang$arity$variadic = fade_in__delegate;
  return fade_in
}();
jayq.core.slide_up = function() {
  var slide_up__delegate = function($elem, p__2882) {
    var vec__2884 = p__2882;
    var speed = cljs.core.nth.call(null, vec__2884, 0, null);
    var on_finish = cljs.core.nth.call(null, vec__2884, 1, null);
    return $elem.slideUp(speed, on_finish)
  };
  var slide_up = function($elem, var_args) {
    var p__2882 = null;
    if(goog.isDef(var_args)) {
      p__2882 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0)
    }
    return slide_up__delegate.call(this, $elem, p__2882)
  };
  slide_up.cljs$lang$maxFixedArity = 1;
  slide_up.cljs$lang$applyTo = function(arglist__2885) {
    var $elem = cljs.core.first(arglist__2885);
    var p__2882 = cljs.core.rest(arglist__2885);
    return slide_up__delegate($elem, p__2882)
  };
  slide_up.cljs$lang$arity$variadic = slide_up__delegate;
  return slide_up
}();
jayq.core.slide_down = function() {
  var slide_down__delegate = function($elem, p__2886) {
    var vec__2888 = p__2886;
    var speed = cljs.core.nth.call(null, vec__2888, 0, null);
    var on_finish = cljs.core.nth.call(null, vec__2888, 1, null);
    return $elem.slideDown(speed, on_finish)
  };
  var slide_down = function($elem, var_args) {
    var p__2886 = null;
    if(goog.isDef(var_args)) {
      p__2886 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 1), 0)
    }
    return slide_down__delegate.call(this, $elem, p__2886)
  };
  slide_down.cljs$lang$maxFixedArity = 1;
  slide_down.cljs$lang$applyTo = function(arglist__2889) {
    var $elem = cljs.core.first(arglist__2889);
    var p__2886 = cljs.core.rest(arglist__2889);
    return slide_down__delegate($elem, p__2886)
  };
...
jayq.core.closest = function() {
  var closest__delegate = function($elem, selector, p__2890) {
    var vec__2892 = p__2890;
    var context = cljs.core.nth.call(null, vec__2892, 0, null);
    return $elem.closest(jayq.core.__GT_selector.call(null, selector), context)
  };
  var closest = function($elem, selector, var_args) {
    var p__2890 = null;
    if(goog.isDef(var_args)) {
      p__2890 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0)
    }
    return closest__delegate.call(this, $elem, selector, p__2890)
  };
  closest.cljs$lang$maxFixedArity = 2;
  closest.cljs$lang$applyTo = function(arglist__2893) {
    var $elem = cljs.core.first(arglist__2893);
    var selector = cljs.core.first(cljs.core.next(arglist__2893));
    var p__2890 = cljs.core.rest(cljs.core.next(arglist__2893));
    return closest__delegate($elem, selector, p__2890)
  };
...
jayq.core.preprocess_request = function preprocess_request(p__2896) {
  var map__2898 = p__2896;
  ...
  var request = map__2898__$1;
  var contentType = cljs.core._lookup.call(null, map__2898__$1, "\ufdd0'contentType", null);
  var data = cljs.core._lookup.call(null, map__2898__$1, "\ufdd0'data", null);
  var ct = jayq.core.__GT_content_type.call(null, contentType);
  return function(p1__2895_SHARP_) {
    if(cljs.core.truth_(jayq.core.clj_content_type_QMARK_.call(null, ct))) {
      return cljs.core.assoc.call(null, p1__2895_SHARP_, "\ufdd0'data", cljs.core.pr_str.call(null, data))
    }else {
      return p1__2895_SHARP_
    }
  }.call(null, function(p1__2894_SHARP_) {
    if(cljs.core.truth_(ct)) {
      return cljs.core.assoc.call(null, p1__2894_SHARP_, "\ufdd0'contentType", ct)
    }else {
      return p1__2894_SHARP_
    }
  }.call(null, request))
};
...
jayq.core.xhr = function xhr(p__2899, content, callback) {
  var vec__2901 = p__2899;
  var method = cljs.core.nth.call(null, vec__2901, 0, null);
  var uri = cljs.core.nth.call(null, vec__2901, 1, null);
...
jayq.core.unbind = function() {
  var unbind__delegate = function($elem, ev, p__2902) {
    var vec__2904 = p__2902;
    var func = cljs.core.nth.call(null, vec__2904, 0, null);
    return $elem.unbind(cljs.core.name.call(null, ev), func)
  };
  var unbind = function($elem, ev, var_args) {
    var p__2902 = null;
    if(goog.isDef(var_args)) {
      p__2902 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0)
    }
    return unbind__delegate.call(this, $elem, ev, p__2902)
  };
  unbind.cljs$lang$maxFixedArity = 2;
  unbind.cljs$lang$applyTo = function(arglist__2905) {
    var $elem = cljs.core.first(arglist__2905);
    var ev = cljs.core.first(cljs.core.next(arglist__2905));
    var p__2902 = cljs.core.rest(cljs.core.next(arglist__2905));
    return unbind__delegate($elem, ev, p__2902)
  };
...
jayq.core.on = function() {
  var on__delegate = function($elem, events, p__2906) {
    var vec__2908 = p__2906;
    var sel = cljs.core.nth.call(null, vec__2908, 0, null);
    var data = cljs.core.nth.call(null, vec__2908, 1, null);
    var handler = cljs.core.nth.call(null, vec__2908, 2, null);
    return $elem.on(jayq.core.__GT_event.call(null, events), jayq.core.__GT_selector.call(null, sel), data, handler)
  };
  var on = function($elem, events, var_args) {
    var p__2906 = null;
    if(goog.isDef(var_args)) {
      p__2906 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0)
    }
    return on__delegate.call(this, $elem, events, p__2906)
  };
  on.cljs$lang$maxFixedArity = 2;
  on.cljs$lang$applyTo = function(arglist__2909) {
    var $elem = cljs.core.first(arglist__2909);
    var events = cljs.core.first(cljs.core.next(arglist__2909));
    var p__2906 = cljs.core.rest(cljs.core.next(arglist__2909));
    return on__delegate($elem, events, p__2906)
  };
  on.cljs$lang$arity$variadic = on__delegate;
  return on
}();
jayq.core.one = function() {
  var one__delegate = function($elem, events, p__2910) {
    var vec__2912 = p__2910;
    var sel = cljs.core.nth.call(null, vec__2912, 0, null);
    var data = cljs.core.nth.call(null, vec__2912, 1, null);
    var handler = cljs.core.nth.call(null, vec__2912, 2, null);
    return $elem.one(jayq.core.__GT_event.call(null, events), jayq.core.__GT_selector.call(null, sel), data, handler)
  };
  var one = function($elem, events, var_args) {
    var p__2910 = null;
    if(goog.isDef(var_args)) {
      p__2910 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0)
    }
    return one__delegate.call(this, $elem, events, p__2910)
  };
  one.cljs$lang$maxFixedArity = 2;
  one.cljs$lang$applyTo = function(arglist__2913) {
    var $elem = cljs.core.first(arglist__2913);
    var events = cljs.core.first(cljs.core.next(arglist__2913));
    var p__2910 = cljs.core.rest(cljs.core.next(arglist__2913));
    return one__delegate($elem, events, p__2910)
  };
  one.cljs$lang$arity$variadic = one__delegate;
  return one
}();
jayq.core.off = function() {
  var off__delegate = function($elem, events, p__2914) {
    var vec__2916 = p__2914;
    var sel = cljs.core.nth.call(null, vec__2916, 0, null);
    var handler = cljs.core.nth.call(null, vec__2916, 1, null);
    return $elem.off(jayq.core.__GT_event.call(null, events), jayq.core.__GT_selector.call(null, sel), handler)
  };
  var off = function($elem, events, var_args) {
    var p__2914 = null;
    if(goog.isDef(var_args)) {
      p__2914 = cljs.core.array_seq(Array.prototype.slice.call(arguments, 2), 0)
    }
    return off__delegate.call(this, $elem, events, p__2914)
  };
  off.cljs$lang$maxFixedArity = 2;
  off.cljs$lang$applyTo = function(arglist__2917) {
    var $elem = cljs.core.first(arglist__2917);
    var events = cljs.core.first(cljs.core.next(arglist__2917));
    var p__2914 = cljs.core.rest(cljs.core.next(arglist__2917));
    return off__delegate($elem, events, p__2914)
  };
...
jayq.core.done = function() {
  ...
  done.cljs$lang$applyTo = function(arglist__2918) {
    var deferred = cljs.core.first(arglist__2918);
    var fns_args = cljs.core.rest(arglist__2918);
...
jayq.core.fail = function() {
  ...
  fail.cljs$lang$applyTo = function(arglist__2919) {
    var deferred = cljs.core.first(arglist__2919);
    var fns_args = cljs.core.rest(arglist__2919);
...
jayq.core.always = function() {
  ...
  always.cljs$lang$applyTo = function(arglist__2920) {
    var deferred = cljs.core.first(arglist__2920);
    var fns_args = cljs.core.rest(arglist__2920);
...
goog.require("cljs.reader");
goog.require("jayq.core");
var $cal_142642 = jayq.core.$.call(null, "\ufdd0'#cal");
var w_142643 = $cal_142642.width();
var h_142644 = $cal_142642.height();
ccal.size = cljs.core.ObjMap.fromObject(["\ufdd0'w", "\ufdd0'h", "\ufdd0'w2", "\ufdd0'h2"], {"\ufdd0'w":w_142643, "\ufdd0'h":h_142644, "\ufdd0'w2":w_142643 / 2, "\ufdd0'h2":h_142644 / 2});
...
ccal.$e_text = jayq.core.$.call(null, "\ufdd0'#e-text");
ccal.$c_wrap = jayq.core.$.call(null, "\ufdd0'#c-wrap");
ccal.$e_wrap = jayq.core.$.call(null, "\ufdd0'#e-wrap");
ccal.$c_edit = CodeMirror.fromTextArea(ccal.$c_text.get(0));
ccal.$e_edit = CodeMirror.fromTextArea(ccal.$e_text.get(0));
ccal.$c_wrap.hide();
ccal.$raf = Raphael("cal", ccal.size.call(null, "\ufdd0'w"), ccal.size.call(null, "\ufdd0'h"));
ccal.spit_cal = function spit_cal() {
  return ccal.$c_edit.setValue(cljs.core.deref.call(null, ccal.cal_text))
};
ccal.spit_evs = function spit_evs() {
  return ccal.$e_edit.setValue(cljs.core.deref.call(null, ccal.evs_text))
};
ccal.line = function line($r, x1, y1, x2, y2) {
  return $r.path(cljs.core.clj__GT_js.call(null, cljs.core.PersistentVector.fromArray(["M", x1, y1, "L", x2, y2], true)))
};
ccal.rotate = function() {
  var rotate = null;
  ...
  var rotate__3 = function($e, deg, p__142645) {
    var vec__142647 = p__142645;
    var cx = cljs.core.nth.call(null, vec__142647, 0, null);
    var cy = cljs.core.nth.call(null, vec__142647, 1, null);
    return $e.transform(cljs.core.clj__GT_js.call(null, cljs.core.PersistentVector.fromArray(["...R", deg, cx, cy], true)))
  };
  rotate = function($e, deg, p__142645) {
    switch(arguments.length) {
      case 2:
        return rotate__2.call(this, $e, deg);
      case 3:
        return rotate__3.call(this, $e, deg, p__142645)
    }
    throw new Error("Invalid arity: " + arguments.length);
  };
  rotate.cljs$lang$arity$2 = rotate__2;
  rotate.cljs$lang$arity$3 = rotate__3;
  return rotate
}();
ccal.translate = function translate($e, x, y) {
  return $e.transform(cljs.core.clj__GT_js.call(null, cljs.core.PersistentVector.fromArray(["...T", x, y], true)))
};
...
ccal.draw_ev = function draw_ev(p__142649, deg) {
  var map__142654 = p__142649;
  var map__142654__$1 = cljs.core.seq_QMARK_.call(null, map__142654) ? cljs.core.apply.call(null, cljs.core.hash_map, map__142654) : map__142654;
  var map__142655 = cljs.core._lookup.call(null, map__142654__$1, "\ufdd0'line", null);
  var map__142655__$1 = cljs.core.seq_QMARK_.call(null, map__142655) ? cljs.core.apply.call(null, cljs.core.hash_map, map__142655) : map__142655;
  var col = cljs.core._lookup.call(null, map__142655__$1, "\ufdd0'col", null);
  var out = cljs.core._lookup.call(null, map__142655__$1, "\ufdd0'out", null);
  var in$ = cljs.core._lookup.call(null, map__142655__$1, "\ufdd0'in", null);
  var map__142656 = cljs.core._lookup.call(null, map__142654__$1, "\ufdd0'label", null);
  var map__142656__$1 = cljs.core.seq_QMARK_.call(null, map__142656) ? cljs.core.apply.call(null, cljs.core.hash_map, map__142656) : map__142656;
  var tsize = cljs.core._lookup.call(null, map__142656__$1, "\ufdd0'tsize", null);
  var tcol = cljs.core._lookup.call(null, map__142656__$1, "\ufdd0'tcol", null);
  var theta = cljs.core._lookup.call(null, map__142656__$1, "\ufdd0'theta", null);
  var trot = cljs.core._lookup.call(null, map__142656__$1, "\ufdd0'trot", null);
  var trad = cljs.core._lookup.call(null, map__142656__$1, "\ufdd0'trad", null);
  var text = cljs.core._lookup.call(null, map__142656__$1, "\ufdd0'text", null);
  var map__142657 = ccal.size;
  var map__142657__$1 = cljs.core.seq_QMARK_.call(null, map__142657) ? cljs.core.apply.call(null, cljs.core.hash_map, map__142657) : map__142657;
  var h2 = cljs.core._lookup.call(null, map__142657__$1, "\ufdd0'h2", null);
  var w2 = cljs.core._lookup.call(null, map__142657__$1, "\ufdd0'w2", null);
  var r = function(p1__142648_SHARP_) {
    return w2 - p1__142648_SHARP_ * cljs.core.deref.call(null, ccal.cal).call(null, "\ufdd0'radius")
  };
  var s = ccal.$raf.set();
  s.push(ccal.line.call(null, ccal.$raf, r.call(null, in$), h2, r.call(null, out), h2).attr("stroke", col));
  if(cljs.core.truth_(text)) {
    s.push(ccal.scale.call(null, ccal.rotate.call(null, ccal.rotate.call(null, ccal.$raf.text(r.call(null, trad), h2, text), theta, cljs.core.PersistentVector.fromArray([w2, h2], true)), trot), tsize).attr("fill", tcol))
  }else {
  }
  return ccal.rotate.call(null, s, deg, cljs.core.PersistentVector.fromArray([w2, h2], true))
};
ccal.day2deg = function day2deg(day) {
  return cljs.core.deref.call(null, ccal.cal).call(null, "\ufdd0'rotate") + day * 360 / 365 + -1
};
ccal.draw_cal = function draw_cal() {
  var map__142661 = ccal.size;
  var map__142661__$1 = cljs.core.seq_QMARK_.call(null, map__142661) ? cljs.core.apply.call(null, cljs.core.hash_map, map__142661) : map__142661;
  var h2 = cljs.core._lookup.call(null, map__142661__$1, "\ufdd0'h2", null);
  var w2 = cljs.core._lookup.call(null, map__142661__$1, "\ufdd0'w2", null);
  ...
  var G__142662_142664 = cljs.core.seq.call(null, cljs.core.range.call(null, 12));
  while(true) {
    if(G__142662_142664) {
      var x_142665 = cljs.core.first.call(null, G__142662_142664);
      ccal.draw_ev.call(null, cljs.core.assoc_in.call(null, cljs.core.deref.call(null, ccal.cal).call(null, "\ufdd0'm-ticks"), cljs.core.PersistentVector.fromArray(["\ufdd0'label", "\ufdd0'text"], true), cljs.core.get_in.call(null, cljs.core.deref.call(null, ccal.cal), cljs.core.PersistentVector.fromArray(["\ufdd0'm-evs", x_142665, 1], true))), ccal.day2deg.call(null, cljs.core.get_in.call(null, cljs.core.deref.call(null, ccal.cal), cljs.core.PersistentVector.fromArray(["\ufdd0'm-evs", x_142665, 
      0], true))));
      var G__142666 = cljs.core.next.call(null, G__142662_142664);
      G__142662_142664 = G__142666;
      continue
    }else {
    }
    break
  }
  var G__142663 = cljs.core.seq.call(null, cljs.core.range.call(null, 52));
  while(true) {
    if(G__142663) {
      var x = cljs.core.first.call(null, G__142663);
      ccal.draw_ev.call(null, cljs.core.deref.call(null, ccal.cal).call(null, "\ufdd0'w-ticks"), ccal.day2deg.call(null, 7 * x));
      var G__142667 = cljs.core.next.call(null, G__142663);
      G__142663 = G__142667;
      continue
    }else {
      return null
...
ccal.draw_evs = function draw_evs() {
  var map__142672 = ccal.size;
  var map__142672__$1 = cljs.core.seq_QMARK_.call(null, map__142672) ? cljs.core.apply.call(null, cljs.core.hash_map, map__142672) : map__142672;
  var h2 = cljs.core._lookup.call(null, map__142672__$1, "\ufdd0'h2", null);
  var w2 = cljs.core._lookup.call(null, map__142672__$1, "\ufdd0'w2", null);
  var defs = cljs.core.deref.call(null, ccal.evs).call(null, "\ufdd0'default");
  var G__142673 = cljs.core.seq.call(null, cljs.core.deref.call(null, ccal.evs));
  while(true) {
    if(G__142673) {
      var vec__142675 = cljs.core.first.call(null, G__142673);
      var k = cljs.core.nth.call(null, vec__142675, 0, null);
      var vs = cljs.core.nth.call(null, vec__142675, 1, null);
      if(cljs.core.number_QMARK_.call(null, k)) {
        var G__142674_142676 = cljs.core.seq.call(null, vs);
        while(true) {
          if(G__142674_142676) {
            var v_142677 = cljs.core.first.call(null, G__142674_142676);
            ccal.draw_ev.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'line", "\ufdd0'label"], {"\ufdd0'line":cljs.core.merge.call(null, defs.call(null, "\ufdd0'line"), v_142677.call(null, "\ufdd0'line")), "\ufdd0'label":cljs.core.merge.call(null, defs.call(null, "\ufdd0'label"), v_142677.call(null, "\ufdd0'label"))}), ccal.day2deg.call(null, k));
            var G__142678 = cljs.core.next.call(null, G__142674_142676);
            G__142674_142676 = G__142678;
            continue
          }else {
          }
          break
        }
        var G__142679 = cljs.core.next.call(null, G__142673);
        G__142673 = G__142679;
        continue
      }else {
        var G__142680 = cljs.core.next.call(null, G__142673);
        G__142673 = G__142680;
        continue
      }
    }else {
...
ccal.draw_both = function draw_both() {
  ccal.$raf.clear();
  ccal.draw_cal.call(null);
  return ccal.draw_evs.call(null)
};
ccal.slurp_cal = function slurp_cal() {
  try {
    var u_cal_text = ccal.$c_edit.getValue();
    var u_cal = cljs.reader.read_string.call(null, u_cal_text);
    ...
    if(cljs.core.instance_QMARK_.call(null, Object, e142682)) {
      var e = e142682;
      return alert(e)
    }else {
      if("\ufdd0'else") {
...
ccal.slurp_evs = function slurp_evs() {
  try {
    var u_evs_text = ccal.$e_edit.getValue();
    var u_evs = cljs.reader.read_string.call(null, u_evs_text);
    ...
    if(cljs.core.instance_QMARK_.call(null, Object, e142684)) {
      var e = e142684;
      return alert(e)
    }else {
      if("\ufdd0'else") {
...
ccal.save_both = function save_both() {
  localStorage.setItem("cal", ccal.$c_edit.getValue());
  return localStorage.setItem("evs", ccal.$e_edit.getValue())
};
ccal.render = function render() {
  ccal.slurp_cal.call(null);
  ccal.slurp_evs.call(null);
  ccal.save_both.call(null);
  return ccal.draw_both.call(null)
};
jayq.core.on.call(null, jayq.core.$.call(null, "\ufdd0'#render"), "\ufdd0'click", ccal.render);
jayq.core.on.call(null, jayq.core.$.call(null, "\ufdd0'#toggle"), "\ufdd0'click", function(e) {
  ccal.$e_wrap.toggle();
  return ccal.$c_wrap.toggle()
});
var temp__3971__auto___142685 = localStorage.getItem("cal");
if(cljs.core.truth_(temp__3971__auto___142685)) {
  var stored_cal_142686 = temp__3971__auto___142685;
  ccal.$c_edit.setValue(stored_cal_142686)
}else {
  ccal.spit_cal.call(null)
}
var temp__3971__auto___142687 = localStorage.getItem("evs");
if(cljs.core.truth_(temp__3971__auto___142687)) {
  var stored_evs_142688 = temp__3971__auto___142687;
  ccal.$e_edit.setValue(stored_evs_142688)
}else {
  ccal.spit_evs.call(null)
}
ccal.render.call(null);
